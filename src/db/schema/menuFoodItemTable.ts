...
export const insertMenuFoodItemSchema = createInsertSchema(menusFoodItemsTable);
export const updateMenuFoodItemSchema = createUpdateSchema(menusFoodItemsTable);
